...
Route::get('/about-us', [App\Http\Controllers\Frontend\HomeController::class, 'about'])->name('home.about');
Route::get('/contact-us', [App\Http\Controllers\Frontend\HomeController::class, 'contact'])->name('home.contact');
Route::get('/login', [App\Http\Controllers\Auth\LoginController::class, 'customer_login'])->name('customer.login');
Route::post('/login', [App\Http\Controllers\Auth\LoginController::class, 'customer_login_action'])->name('customer.login.action');
Route::get('/register', [App\Http\Controllers\Auth\UserRegistration::class, 'create'])->name('customer.register');
Route::post('/register', [App\Http\Controllers\Auth\UserRegistration::class, 'store'])->name('customer.register.post');
...
Route::prefix('admin')->group(function () {
	...
	Route::group(['middleware' => 'language', ['role:Admin']], function () {
...
Route::prefix('user')->group(function () {
	Route::group(['middleware' => ['auth']], function () {
	Route::get('/dashboard', 					[App\Http\Controllers\Dashboard\Userdashboard::class, 'dashboard']);
	Route::get('/logout', 					[App\Http\Controllers\Dashboard\Userdashboard::class, 'logout'])->name('customer.logout');
});
});
