...
<head>
  ...
  <title><?php echo e($setting->website_title); ?>  :: Dashboard</title>
  <!-- Application vendor css url -->
  <link rel="stylesheet" href="<?php echo e(asset('dashboard/cssbundle/dataTables.min.css')); ?>">
  <!-- project css file  -->
  <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/avio-style.css')); ?>">
  <!-- Jquery Core Js -->
...
<?php echo $__env->yieldContent('content'); ?>
  ...
  <!-- Plugin Js -->
  <script src="<?php echo e(asset('dashboard/js/bundle/apexcharts.bundle.js')); ?>"></script>
  <script src="<?php echo e(asset('dashboard/js/bundle/dataTables.bundle.js')); ?>"></script>
  <!-- Jquery Page Js -->
  <script>
    // AVIO Revenue
    var options = {
...
</html><?php /**PATH C:\laragon\www\laraveladminpanel\resources\views/dashboard/layout/master.blade.php ENDPATH**/ ?>