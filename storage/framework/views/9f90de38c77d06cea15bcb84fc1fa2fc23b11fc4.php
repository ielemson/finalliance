            ...
            <div class="ph-tab">
              ...
              <section>
                ...
                <div class="tab1 rounded-4">
                  ...
                  <script src="<?php echo e(asset('dashboard/js/bundle/owlcarousel.bundle.js')); ?>"></script>
                  <script>
                    var owl = $('.owl_summary');
                    owl.owlCarousel({
                      items: 4,
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laraveladminpanel\resources\views/dashboard/home.blade.php ENDPATH**/ ?>