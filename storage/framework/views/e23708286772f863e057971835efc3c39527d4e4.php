...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="mobile" value="<?php echo e(old('mobile')); ?>" placeholder="Mobile Number" class="form-control <?php $__errorArgs = ['mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo e(route('customer.login')); ?>" class="theme-btn">Login</a>
                                </div>                                        
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laraveladminpanel\resources\views/frontend/auth/register.blade.php ENDPATH**/ ?>