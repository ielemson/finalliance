    ...
    <div class="container-fluid">
      <div class="d-flex justify-content-between">
        ...
        <a class="navbar-brand d-flex align-items-center color-900" href="{{url('/')}}">
          ...
          <span class="h4 mb-0 fw-bold ps-2">{{$setting->website_title}} </span>
        </a>
        <!-- Header:: Menu and Mega menu link -->
        <div class="menu-link flex-fill">
          <!-- Start:: dashboard link -->
          <div class="dropdown menu-apps active">
            <a href="{{url('user/dashboard')}}" class="btn btn-link dropdown-toggle after-none" data-bs-toggle="dropdown">
          ...
          <div class="dropdown menu-apps active">
            <a href="{{route('home')}}" class="btn btn-link dropdown-toggle after-none" data-bs-toggle="dropdown">
              <svg class="mx-1" xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
          ...
          <li>
            <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
              <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                <img class="avatar lg img-thumbnail rounded-circle shadow" src="{{asset('dashboard/img/profile_av.png')}}" alt="">
              </a>
              <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                <div class="card w240 overflow-hidden">
                  <div class="card-body">
                    ...
                    <a href="{{route('customer.logout')}}" class="btn bg-secondary text-light text-uppercase w-100">Sign out</a>
                  </div>
